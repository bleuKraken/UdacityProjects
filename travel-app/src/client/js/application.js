  ...
  if (countryAreaContainer.classList.contains('hidden')) {
    ...
    getCityInfo(baseURL, city, code, userName)
      .then(function(data) {
        ...
        //alert("Linky: " + baseCountryInfo + countryCode + placeNameRequest + userName)
        ...
        .then(function(data) {
          ...
          //alert("Linky: " + baseCountryId + countryGeonameId + countryGeonameCode + userName)
            ...
            .then(function(data) {
              ...
              getWeather('http://localhost:4444/weather', weatherData)
                .then(function(weatherData) {
                  ...
                  let cityNameFromWeatherAPI = weatherData.city_name;
                  // TODO:: CONSOLE LOBE ABOVE AND TEST
                  let cityPhoto = '&q=city+of+' + cityNameFromWeatherAPI.replace(/ /g, "+") + '&image_type=photo';  // ########## THIS IS DIFFRENT
    ...
    if (areaSelected.options[areaSelected.selectedIndex] === undefined) {
      alert("Oh no")
    }

  } else {
    // LINE 65     areaSelected.options[areaSelected.selectedIndex] is undefined
